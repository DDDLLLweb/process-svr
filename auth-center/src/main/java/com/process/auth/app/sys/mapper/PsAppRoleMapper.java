...
public interface PsAppRoleMapper {
    ...
    List<PsAppRoleEntity> pages(PsAppRoleQuery query);
    ...
    PsAppRoleEntity getEntity(long id);
    ...
    int insertEntity(PsAppRoleEntity appUser);
    ...
    int updateEntity(PsAppRoleEntity appUser);
